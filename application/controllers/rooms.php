...
class Rooms extends BaseController
{
    ...
    public function freeroom(){
        $this->global['pageTitle'] = 'DigiLodge : Free Room Listing';
        $data['freeroom'] = $this->rooms_model->getRuanganFree();
        $this->loadViews("rooms/freeroom", $this->global,$data , NULL);
    }


     public function fullroom(){
        $this->global['pageTitle'] = 'DigiLodge : Full Room Listing';
        $data['fullroom'] = $this->rooms_model->getRuanganFull();
        $this->loadViews("rooms/fullroom", $this->global,$data , NULL);
    }

    public function bookinglist(){
        $this->global['pageTitle'] = 'DigiLodge : Booking list';
        $data['bookingroom'] = $this->rooms_model->getbookinglist();
        $this->loadViews("rooms/bookinglist", $this->global,$data , NULL);
    }
