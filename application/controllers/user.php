...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        if($this->user_model->getRuanganTelahDipakai()>1){
            $free = ($this->user_model->getRuanganFree()-$this->user_model->getRuanganTelahDipakai());
        }else{
            $free = $this->user_model->getRuanganFree();
        }
        $data['freeroom'] = $this->user_model->getRuanganfree();
        $data['fullroom'] = $this->user_model->getRuanganFull();
        $data['bookinglist'] = $this->user_model->getBookingListing();
    ...
    function addNewUser()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $userInfo = array('userNIK'=>$email, 'userPassword'=>getHashedPassword($password), 'roleId'=>$roleId, 'userName'=> $name,
